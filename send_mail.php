...
$m->addAddress('manny.muriel@perficient.com', 'Manny Work');
$m->addAddress('sanclunatic@aim.com', 'Manny personal');
$m->addAddress('gideon.banez@perficient.com', 'Gideon Work');
